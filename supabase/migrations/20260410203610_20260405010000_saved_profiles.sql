/*
  ...
  1. New Tables
    - `saved_profiles` - caches enrichment results per LinkedIn URL per user
      - id, user_id, linkedin_url, full_name, work_email, personal_email
      - title, company, title_verified, email_status, enriched_at
